...
#class scrapycrawl(scrapy.Spider):
 #   name = 'blogspider'
 #   start_urls = ['https://www.codegrepper.com/code-examples/python/WARNING%3A+You+are+using+pip+version+20.1%3B+however%2C+version+20.2.4+is+available']
#
